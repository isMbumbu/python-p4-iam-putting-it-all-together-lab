...
class TestUser:
    ...
    def test_has_attributes(self):
        ...
        with app.app_context():
            ...
            # Clear existing records for a clean test environment
            User.query.delete()
            db.session.commit()
            ...
            bio_text = (
                ...
                "She began her career as a child actress in the early 1940s and was one of the most popular stars of classical "
                "Hollywood cinema in the 1950s. She then became the world's highest paid movie star in the 1960s, remaining "
                "a well-known public figure for the rest of her life. In 1999, the American Film Institute named her the "
                "seventh-greatest female screen legend of Classic Hollywood cinema."
            )
            ...
            # Fetch and validate created user
            ...
            assert created_user.bio == bio_text
    
            # Verify password hash is not directly accessible
